...
func FwdNTTInPlacePow2UnrollAVX2() {
	TEXT("fwdNTTInPlacePow2UnrollAVX2", NOSPLIT, "func(coeffs, tw, twS []uint64, q uint64)")
	Pragma("noescape")
	...
	FwdButterflyAVX2(u, v, w, wSwap, wS, wSHi, q, qSwap, twoQ, maskLo, maskHi, maskSign)
	...
	FwdButterflyX86(u64, v64, w64, wS64, q64, twoQ64)
...
func FwdNTTInPlacePow2UnrollAVX512() {
	...
	FwdButterflyAVX512YMM(u256, v256, w256, wS256, wSHi256, q256, twoQ256, maskLo256)
...
func InvNTTInPlacePow2UnrollAVX2() {
	TEXT("invNTTInPlacePow2UnrollAVX2", NOSPLIT, "func(coeffs, twInv, twInvS []uint64, q uint64)")
	Pragma("noescape")
