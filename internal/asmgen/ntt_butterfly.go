...
func FwdButterflyAVX2(u, v, w, wSwap, wS, wSHi, q, qSwap, twoQ, maskLo, maskHi, maskSign reg.VecVirtual) {
	subQ := YMM()
	GreaterOrEqualThanAVX2(u, twoQ, maskSign, subQ)
...
func FwdButterflyAVX512YMM(u, v, w, wS, wSHi, q, twoQ, maskLo reg.VecVirtual) {
	vHi := YMM()
	VPSRLQ(Imm(32), v, vHi)
...
func FwdButterflyX86(u, v, w, wS, q, twoQ reg.Register) {
	subQ := GP64()
	MOVQ(u, subQ)
	SUBQ(twoQ, subQ)
	CMPQ(u, twoQ)
...
func InvButterflyAVX2(u, v, w, wSwap, wS, wSHi, q, qSwap, twoQ, maskLo, maskHi, maskSign reg.VecVirtual) {
	VPADDQ(v, u, u)
	VPADDQ(v, v, v)
	VPSUBQ(v, u, v)
	VPADDQ(twoQ, v, v)
